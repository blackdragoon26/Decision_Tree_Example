...
current_dir="/home/motherfunder/IamWorking/parvezMaam/Decision_Tree_Example/sampledecisiontrees/e4"
    ...
    for node_id, label in nodes.items():
        ...
        if match:
            ...
            if original_feature not in feature_alias:
                if alias_index > 8:
                    raise ValueError("❌ More than 7 unique features found. Aborting.")
